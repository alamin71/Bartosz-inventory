...
export default function SuggestedPackages() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      if (storedAnswers) {
        ...
        const trueAnswers = parsedAnswers.filter(
  ...
  return (
    <div>
      <div className="relative h-[calc(100vh-80px)] bg-black/70 px-20 py-8 rounded-lg">
        <Image
          src={bgImage}
          alt="bg-image"
          fill
        ...
        <div className="text-white bg-black/80 flex flex-col p-8 items-center">
          <div className="py-4">
            <p className="text-base sm:text-5xl font-bold text-center">
              {t("title")}
            </p>
            <hr className="w-[240px] sm:w-[540px] border-t-2 border-[#FF0060] mt-2 ml-6" />
            <hr className="w-[240px] sm:w-[540px] mt-2 ml-12 border-t-2 mr-6" />
          </div>
          <div className="rounded-lg mx-40 mb-4 p-4">
