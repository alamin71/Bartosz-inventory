    ...
    <div>
      <div className="relative w-full h-[calc(100vh-80px)] bg-black/90">
        ...
        <div className="text-white flex flex-col items-center pt-10 sm:pt-48">
          <p className="sm:text-7xl font-bold">{t("title")}</p>
          <hr className="w-[240px] sm:w-[540px] ml-20 mr-24 border-t-2 border-[#FF0060]" />
          <hr className="w-[240px] sm:w-[540px] mt-2 ml-5 sm:ml-20 border-t-2" />
