...
//   // Updated monthly sales calculation: sum of 3 inputs × premises
//   useEffect(() => {
//     const beverage = parseFloat(inputValues[0]) || 0;
//     const food = parseFloat(inputValues[1]) || 0;
//     const menuEngineering = parseFloat(inputValues[2]) || 0;
//     const totalSales = (beverage + food + menuEngineering) * numOfPremises;
...
//           <div className="flex justify-between gap-2 items-center" key={index}>
//             <p className="mb-1 text-right text-xs sm:text-base w-1/2">
//               {item.problem === "I want to earn more with menu engineering"
//                 ? "My monthly sales in total is"
//                 : t(`${item.problem}`)}
//             </p>
//             {["1", "2", "3"].includes(item.id) ? (
...
//               <p className="mb-1 text-right text-xs sm:text-base w-1/2">
//                 {item.id === "1"
//                   ? "My monthly beverages sales revenue is"
//                   : item.id === "2"
//                   ? "My monthly food sales revenue is"
//                   : "My monthly sales in total is"}
//               </p>
//               <input
//                 type="text"
